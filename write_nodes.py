...
def _calibrate_risk(score: float, features: dict) -> str:
    """
    Post-model calibration using qSOFA + Sepsis-3 vital thresholds.
    Fixes bimodal XGBoost output with clinically grounded risk tiers.
    qSOFA: resp_rate >= 22 (+1), systolic_bp <= 100 (+1).
    """
